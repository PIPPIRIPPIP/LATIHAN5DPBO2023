...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        // Dummy
        listMhs.add(new Mahasiswa("2101990", "Ayesha", "A", "Laki-laki"));
        listMhs.add(new Mahasiswa("2101991", "Skypaaww", "A", "Perempuan"));
        listMhs.add(new Mahasiswa("2101992", "Pirpaaww", "A", "Laki-laki"));
    ...
    public void updateData() {
        ...
        // set Data to Object
        listMhs.get(selectionId).setNim(nim);
        listMhs.get(selectionId).setNama(nama);
        listMhs.get(selectionId).setNilai(nilai);
        listMhs.get(selectionId).setGender(gender);
    ...
    public void deleteData() {
        int confirm = JOptionPane.showConfirmDialog(this, "Apakah yakin akan menghapus data?", "Message", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(confirm == JOptionPane.YES_OPTION){

            // Remove Data from List
            listMhs.remove(selectionId);
    ...
    private void tblMhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMhsMouseClicked
        ...
        jComboBoxGender.setSelectedItem(selectedGender);
    ...
    private void jComboBoxGenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CBGenderActionPerformed
        // TODO add your handling code here:
